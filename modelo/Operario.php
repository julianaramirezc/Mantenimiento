 ...
 * Implementa el CRUD para Operario
 * @authors Juliana Ramirez Corrales, Luis Daniel Murillo Zuluaga, Mateo Castro González, Jose Fernando Giraldo Giraldo
 */
class Operario {

    function add($param) {
        //El metodo add, inserta los valores en la base de datos correspondientes ala entidad operario.
        extract($param);
    ...
    function edit($param) {
        //El metodo edit, actualiza los valores en la base de datos correspondientes ala entidad operario.
        extract($param);
    ...
    function del($param) {
        //El metodo del, elimina los valores en la base de datos correspondientes ala entidad operario.
        extract($param);
            ...
            while ($fila = $rs->fetch(PDO::FETCH_ASSOC)) {
                ...
                $respuesta['rows'][] = [
                    ...
                    'cell' => [ // los campos que se muestra en las columnas del grid
                        ...
                        $fila['telefonos'],
                        $fila['correos'],
                        '' //observe que no enviamos a $fila['contrasena'], esto con el fin de obligar a cambiarla cada vez que editen un registro
                    ]
                ];
            }
        }
    ...
    public function getOperario($param){
        $json = FALSE;
        extract($param);
    }
