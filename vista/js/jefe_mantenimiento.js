...
$(function () {
    ...
    var clase = 'JefeMantenimiento';  // la clase que implementa el CRUD para este grid
    var idPager = 'jefe_mantenimiento-pager';  // la barra de navegación del grid ubicada en la parte inferior
    ...
    var columnas = [
        ...
        {'label': 'Apellidos', name: 'apellidos', align: 'center', index: 'apellidos', width: 130, sortable: true, editable: true,
            editrules: {required: true, custom: true, custom_func: validarPersona},
            editoptions: {dataInit: asignarAncho}
        },
        {'label': 'Dirección', name: 'direccion', align: 'center', index: 'direccion', width: 150, sortable: true, editable: true,
            editrules: {required: false},
            editoptions: {dataInit: asignarAncho}
        },
        {'label': 'Teléfono', name: 'telefonos', align: 'center', index: 'telefonos', width: 120, sortable: true, editable: true,
            editrules: {required: false},
            editoptions: {dataInit: asignarAncho}
        },
        {'label': 'Correo', name: 'correos', align: 'center', index: 'correos', width: 160, sortable: true, editable: true,
            editrules: {required: false, custom: true, custom_func: validarPersona},
            editoptions: {dataInit: asignarAncho}
        },
        {'label': 'Contraseña', name: 'contrasena', hidden: true, edittype: 'password', index: 'contrasena', width: 180, sortable: true, editable: true,
    ...
    // inicializa el grid
    var grid = jQuery('#jefe_mantenimiento-grid').jqGrid({
