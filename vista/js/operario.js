...
$(function () {
    ...
    var clase = 'Operario';  // la clase que implementa el CRUD para este grid
    var idPager = 'operario-pager';  // la barra de navegación del grid ubicada en la parte inferior
    ...
    var columnas = [
        ...
        {'label': 'Correo', name: 'correos', align: 'center', index: 'correos', width: 160, sortable: true, editable: true,
            editrules: {custom: true, custom_func: validarPersona},
            editoptions: {dataInit: asignarAncho}
        },
        {'label': 'Contraseña', name: 'contrasena', index: 'contrasena', width: 180, sortable: true, editable: true, hidden: true, edittype: 'password',
    ...
    // inicializa el grid
    var grid = jQuery('#operario-grid').jqGrid({
