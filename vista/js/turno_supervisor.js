...
$(function () {
    ...
    var clase = 'TurnoSupervisor';  // la clase que implementa el CRUD para este grid
    var idPager = 'turno-pager';  // la barra de navegación del grid ubicada en la parte inferior
$("#operproduccion-supervisor").html(getElementos({'clase': 'Supervisor', 'oper': 'getSelect', 'json': true})).on("change", function () {
    ...
    var columnas = [
        ...
        {'label': 'Supervisor', name: 'id_usuario', index: 'id_usuario', align:"center", width: 80, sortable: true, editable: true, edittype: 'select',
            editrules: {required: true,custom:true, custom_func: validarTurno},
            editoptions: {
                dataUrl: 'controlador/fachada.php?clase=Supervisor&oper=getSelect',
